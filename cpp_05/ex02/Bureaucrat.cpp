...
// - This improves **perAformance** and makes the code **safer** by avoiding unnecessary exception-handling overhead.
...
void Bureaucrat::decrement_grade() {
 ...
 void   Bureaucrat::signAForm(AForm &a){
    ...
    if (a.get_sign())
        ...
        std::cout <<  name << " couldn’t sign " << a.get_name()<< " because Grade too low to sign the Aform" << std::endl;
 };
